...
Respond ONLY with JSON in exactly this shape:
{
  "scenario": "2-4 sentences setting up the new situation/context — prose only, no bullet points or requirements mixed in here",
...
Keep "scenario" as flowing prose describing the situation only. Put every distinct task/requirement as its own short string in the "requirements" array — do not embed bullet characters like * or - inside any string. Write the worked_answer_sections as genuinely complete, well-written academic prose — this is a teaching model, not a skeleton. The whole point is to fully demonstrate technique on a question that is NOT theirs to submit.`;
